...
import { todayDate, updateRecord } from '../common.js';
      ...
      querySnapshot.forEach(doc => {
        historyDetails.innerHTML += `
          <div
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 text-rose-600 absolute -bottom-2 left-1/2 -translate-x-1/2 updateRecord" data-update="deleteBaseAmount">
